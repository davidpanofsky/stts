...
class Service {
    ...
    static func all() -> [Service] {
        let allServices = [
            ...
            EngineYard.self,
            GitHub.self,
            GoogleAppEngine.self,
            GoogleComputeEngine.self,
            GoogleCloudStorage.self,
            GoogleBigQuery.self,
            GoogleCloudDataproc.self,
            GoogleCloudDatastore.self,
            GoogleCloudDNS.self,
            GoogleCloudPubSub.self,
            GoogleCloudSQL.self,
            GoogleCloudDataflow.self,
            GoogleContainerEngine.self,
            GoogleCloudConsole.self,
            GoogleStackdriver.self,
            GoogleCloudBigtable.self,
            Heroku.self,
            Intercom.self,
            KeenIO.self,
            MediaTemple.self,
